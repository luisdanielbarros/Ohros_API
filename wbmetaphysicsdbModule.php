<?php
class wbMetaphysicstDatabaseModule {
    //WB
    //WB -> Create Metaphysic
    function wb_create_metaphysic($pdo, $_projectId, $_Concept, $_ReasonOfConcept, $_WBname, $_Summary, $_Description, $_Cause, $_Purpose, $_Myth) {
        //Check if user hasn't reached the maximum number of metaphysics
        ...
        if ($count > 99) {
            ...
            $json_response = array('messageTitle' => 'Metaphysic Creation Failure.', 'message' => 'Metaphysic creation failure: user has already reached the maximum number of metaphysics per project.', 'content' => array());
            ...
            if (!$results) {
                http_response_code(400);
                $json_response = array('messageTitle' => 'Metaphysic Creation Failure.', 'message' => 'Metaphysic creation failure: the system is currently unavailable, please try again later.', 'content' => array());
                echo json_encode($json_response);
            }
            else {
                $wbId = (int)$pdo->lastInsertId();
                //Create the base
                $sql2 = 'INSERT INTO wb_metaphysics (Id_Base) VALUES (:Id_Base)';
                ...
                if (!$results2) {
                    ...
                    $json_response = array('messageTitle' => 'Metaphysic Creation Success.', 'message' => 'Metaphysic creation successful.', 'content' => array());
                    echo json_encode($json_response);
                }
            }
        }
    ...
    function wb_update_metaphysic($pdo, $_wbId, $_Concept, $_ReasonOfConcept, $_WBname, $_Summary, $_Description, $_Cause, $_Purpose, $_Myth) {
        ...
        if (!$results) {
            http_response_code(400);
            $json_response = array('messageTitle' => 'Metaphysic Update Failure.', 'message' => 'Metaphysic update failure: the system is currently unavailable, please try again later.', 'content' => array());
            echo json_encode($json_response);
        }
        else {
            http_response_code(200);
            $json_response = array('messageTitle' => 'Metaphysic Update Success.', 'message' => 'Metaphysic update successful.', 'content' => array());
            echo json_encode($json_response);
        }
    }
    //WB -> Delete Metaphysic
    function wb_delete_metaphysic($pdo, $_Projpass, $_projectId, $_wbId) {
        ...
        if ($count != 1) {
            http_response_code(400);
            $json_response = array('messageTitle' => 'Metaphysic Deletion Failure.', 'message' => 'Metaphysic deletion failure: the password is incorrect.', 'content' => array());
            echo json_encode($json_response);
        }
        else {
            //Delete the metaphysic's information
            $sql2 = 'DELETE FROM wb_metaphysics WHERE Id_Base = :Id_Base';
            $statement2 = $pdo->prepare($sql2);
            $statement2->bindParam(':Id_Base', $_wbId, PDO::PARAM_INT);
            $results2 = $statement2->execute();
            if (!$results2) {
                http_response_code(400);
                $json_response = array('messageTitle' => 'Metaphysic Deletion Failure.', 'message' => 'Metaphysic deletion failure: the system is currently unavailable, please try again later.', 'content' => array());
                echo json_encode($json_response);            
            }
            else {
                ...
                if (!$results3) {
                    ...
                    http_response_code(200);
                    $json_response = array('messageTitle' => 'Metaphysic Deletion Success.', 'message' => 'Metaphysic deletion successful.', 'content' => array());
                    echo json_encode($json_response);
                }
            }
        }
    ...
    //WB -> View Metaphysics
    function wb_view_metaphysics($pdo, $_projectId) {
        //Select the metaphysic's information
        ...
        INNER JOIN wb_metaphysics ON wb_bases.Id = wb_metaphysics.Id_Base
        ...
        http_response_code(200);
        $json_response = array('messageTitle' => 'Metaphysics Viewing Success.', 'message' => 'Metaphysics viewing successful.', 'content' => $toReturn);
        echo json_encode($json_response);    
	}
    //WB -> View Metaphysic
    function wb_view_metaphysic($pdo, $_wbId) {
        //Select the metaphysic's information
        ...
        http_response_code(200);
        $json_response = array('messageTitle' => 'Metaphysic Viewing Success.', 'message' => 'Metaphysic viewing successful.', 'content' => $toReturn);
        echo json_encode($json_response);    
    }
}
?>